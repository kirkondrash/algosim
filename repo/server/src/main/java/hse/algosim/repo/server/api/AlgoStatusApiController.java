...
public class AlgoStatusApiController implements AlgoStatusApi {
    ...
    @Override
    public ResponseEntity<SrcStatus> getAlgorithmStatus(UUID id) {
    ...
    @Override
    public ResponseEntity<Void> replaceAlgorithmStatus(UUID id, @Valid SrcStatus srcStatus) {
        if (!srcStatuses.containsKey(id))
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
    ...
    @Override
    public ResponseEntity<Void> uploadAlgorithmStatus(UUID id, @Valid SrcStatus srcStatus) {
        if (srcStatuses.containsKey(id))
