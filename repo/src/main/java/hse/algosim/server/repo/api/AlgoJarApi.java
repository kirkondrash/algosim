...
public interface AlgoJarApi {
    ...
    @PostMapping(value = "/algoJar/{id}", consumes = { MediaType.MULTIPART_FORM_DATA_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE })
    ...
    @GetMapping(value = "/algoJar/{id}", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_OCTET_STREAM_VALUE })
    ...
    @PutMapping(value = "/algoJar/{id}", consumes = { MediaType.MULTIPART_FORM_DATA_VALUE }, produces = { MediaType.APPLICATION_JSON_VALUE })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Artifact not found for this id") })
    @DeleteMapping(value = "/algoJar/{id}", produces = { MediaType.APPLICATION_JSON_VALUE })
